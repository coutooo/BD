...
namespace Proj_bd
{
    public partial class Fornecedores : Form
    {
        ...
        private void loadBox1()
        {
            ...
            SqlCommand cmd = new SqlCommand("SELECT * FROM Fornecedores", ConcBD.cn);
            ...
            while (reader.Read())
            {
                ...
                p.Empresa = reader["Empresa"].ToString();
        ...
        public void ShowFunc()
        {
            if (listBox1.Items.Count == 0 | currentFunc < 0)
                return;
            Fornecedor contact = new Fornecedor();
            contact = (Fornecedor)listBox1.Items[currentFunc];
        ...
        {
            Fornecedor ult = (Fornecedor)listBox1.Items[listBox1.Items.Count - 1];
            textBox1.Text = "";
            textBox2.Text = "";
            textBox3.Text = "";
            textBox4.Text = "";
        ...
        private bool SalvarFornecedor()
        {
            ...
            {
                ConcBD.verifySGBDConnection();
                SqlCommand cmd = new SqlCommand("EXEC AddForncedor @NIF, @Nome, @Telefone, @Morada, @Idade, @Numero, @Empresa", ConcBD.cn);
                cmd.Parameters.AddWithValue("@Numero", contact.Numero);
                cmd.Parameters.AddWithValue("@NIF", contact.NIF);
                cmd.Parameters.AddWithValue("@Empresa", contact.Empresa);
            ...
            {
                ConcBD.verifySGBDConnection();
                SqlCommand cmd = new SqlCommand("EXEC UpdateFornecedor @NIF, @Nome, @Telefone, @Morada, @Idade, @Numero, @Empresa", ConcBD.cn);
                cmd.Parameters.AddWithValue("@Numero", contact.Numero);
                cmd.Parameters.AddWithValue("@NIF", contact.NIF);
                cmd.Parameters.AddWithValue("@Empresa", contact.Empresa);
                cmd.Parameters.AddWithValue("@Nome", contact.Nome);
